    ...
    <b-navbar toggleable="md" variant="light" type="light">
      ...
      <b-collapse is-nav id="nav_collapse">
        <b-navbar-nav>
          ...
          <b-nav-item to="/add"><i class="fa fa-plus" style="padding: 5px"> Add Pet</i></b-nav-item>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item to="/register"><i class="fa fa-user" style="padding: 5px"> Register </i></b-nav-item>
